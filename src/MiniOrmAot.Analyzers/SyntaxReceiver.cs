...
public class SyntaxReceiver : ISyntaxContextReceiver {
    private static readonly Assembly AnalyzerAssembly = typeof(SourceGenerator).Assembly;
    private static readonly string AnalyzerNamespace = typeof(SourceGenerator).Namespace;
