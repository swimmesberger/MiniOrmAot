...
namespace MiniOrmAot.Analyzers {
    public class SourceGenerator {
        ...
        private void ReportError(Exception e) {
            var descriptor = new DiagnosticDescriptor(nameof(OrmSourceGenerator), "Error",
                    $"{nameof(OrmSourceGenerator)} failed to generate Interface due to an error. Please inform the author. Error: {e}",
